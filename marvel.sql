...
-- SELECT name FROM people WHERE name  = 'Alex	MacFadyen';
...
-- SELECT * FROM people; returns the below:
-- id |         name
-- ----+----------------------
--   1 | Clare   Blackburne
--   3 | Alistair        Kane
...
-- SELECT * FROM people; produces the following:
-- id |         name
-- ----+----------------------
--   1 | Clare   Blackburne
--   3 | Alistair        Kane
...
-- SELECT * FROM movies; produces the following:
-- id |                title                | year | show_time
-- ----+-------------------------------------+------+-----------
--  1 | Iron Man                            | 2008 | 19:40
--  2 | The Incredible Hulk                 | 2008 | 18:05
...
-- SELECT * FROM movies; return the following:
-- id |                title                | year | show_time
-- ----+-------------------------------------+------+-----------
--  1 | Iron Man                            | 2008 | 19:40
--  2 | The Incredible Hulk                 | 2008 | 18:05
...
DELETE FROM attendances WHERE person_id = 1 OR person_id = 9;

SELECT * FROM attendances;
-- deletes 11 from the list of attendances
